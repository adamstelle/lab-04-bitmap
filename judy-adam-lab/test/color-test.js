...
//   describe('core ColorManipulation function', function() {
//     it('should access the color array within the bitmap buffer', function() {
//
//     });
//   });
//   describe('.colorInvert function', function() {
//     it('invert each color on the original buffer fil by subtracting it from 255', function() {
//
//     });
